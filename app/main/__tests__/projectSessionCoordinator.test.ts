...
describe('ProjectSessionCoordinator', () => {
  ...
  it('activates one canonical project and produces role-projected snapshots', () => {
    ...
    expect(command.project?.unitMetrics).toEqual({
      unit_1: { wordCount: 1, sentenceCount: 1, paragraphCount: 1, dialogueRatio: 0, bodySha256: '421dc617d921c24f41441973d8476605718a14a5c2228b8344cc1d6d816e8d39' },
    });
