...
export interface AnalyticsRelationshipNode {
  id: string;
  label: string;
  type: string;
}

export interface AnalyticsRelationshipEdge {
  from: string;
  to: string;
  kind: string;
}

export interface AnalyticsRelationshipGraph {
  projectId: string;
  nodes: AnalyticsRelationshipNode[];
  edges: AnalyticsRelationshipEdge[];
}
