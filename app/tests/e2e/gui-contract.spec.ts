...
// HARNESS_ONLY:
// Reason: checks renderer/gui contract wiring with harness bridges.
// Owner: app/tests/e2e/gui-contract.spec.ts
// Retire when: contract assertions are enforced from truth-lane artifacts.
