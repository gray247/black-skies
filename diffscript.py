...
actual = Image.open(
    "app/test-results/visual.home-Visual-snapshots-home-screen-electron/home-actual.png"
)
...
print(
    "total diff sum",
    sum((value for channel in diff.getbands() for value in diff.getchannel(channel).getdata())),
)
