...
BANNED_RULES: tuple[Rule, ...] = (
    ...
    Rule("app/temp-trace/**", "Historical trace or generated diagnostic"),
    Rule("ci_artifacts/**", "Historical CI artifact"),
    Rule("build/ci_proof/**", "Generated CI proof"),
    Rule("build/truth_receipts/**", "Generated truth receipt"),
