...
- one scene or prose editor surface,
...
Minimal v0 should be optimized for one thing: opening a project and writing scenes without inherited UI clutter or bridge sprawl.
...
The first code slice should not attempt persistence, migration, recovery expansion, export expansion, or qualitative evaluator runtime use.
