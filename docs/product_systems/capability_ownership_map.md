...
| Capability | Current owner | Supporting systems | Authority or state owned | Explicit non-owner boundaries | Lifecycle stage | Maturity | Unresolved Jason decision | Important overlap or duplication risk |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| accepted character facts | `Character Cards` | `Writing Surface`, `Command Center`, `Continuity`, `Critique` | accepted character truth | continuity, critique, memory, and inference do not own character truth | existing dossier | shallow | none | overlap with relationship and emotion support |
| accepted lore and canon facts | `Lore Cards` | `Writing Surface`, `Command Center`, `Continuity`, `Critique` | accepted lore truth | import, memory, critique, and continuity are non-owners | existing dossier | shallow | none | overlap with continuity and research notes |
| relationship views and accepted relationship support | `Relationship Map` for advisory and view state; accepted truth still lands in explicit truth owner | `Character Cards`, `Lore Cards`, `Writing Surface`, `Command Center` | relationship view state and candidate relationship support | map does not own canon by default | existing dossier | shallow | none | overlap with character truth and continuity |
| emotional trajectory support | `Emotion Graph` for advisory and view state | `Writing Surface`, `Command Center`, `Theme System`, `Critique` | emotional-intent support and advisory graph state | inferred emotion is not author intent by default | existing dossier | shallow | none | overlap with critique, theme, and pacing |
| thematic organization and advisory theme support | `Theme System` | `Writing Surface`, `Command Center`, `Outline`, `Critique` | author-defined theme support plus advisory theme findings | story-theme support is distinct from cosmetic UI theme work | existing dossier | shallow | none | duplicate term `theme` already collides with UI theming |
...
| foreshadow and payoff review | `Foreshadow / Payoff` | `Outline`, `Continuity`, `Critique` | advisory pattern review | no truth ownership | existing dossier | shallow | none | overlap with continuity and pacing |
