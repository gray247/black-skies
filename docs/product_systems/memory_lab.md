...
Likely nothing by default beyond downstream findings and evidence-backed outputs.
...
It must not replace them as truth identity.

## 17. Relationship To Story Units

Story Units may provide optional scope or grouping context, but Memory Lab must not depend on them as foundation.

## 18. Relationship To Prose / Scene Projection

Memory Lab may read projections and prose, but scene remains compatibility or projection only.

## 19. Relationship To Writing Surface

Memory Lab should support the Writing Surface indirectly and not intrude as a constant visible authority.

## 20. Relationship To Command Center Surface

The Command Center is the most likely host for explicit Memory Lab inspection and investigation controls later.
...
Local models may support bounded forensic reading or evidence extraction when affordable.

## 23. Paid API Role

Paid API is for deep, broad, or long-context investigations when routing and budget rules permit.
...
Doctrine only plus evidence and authority boundaries.

## 31. v2 Boundary

Bounded investigative workflows, explicit evidence inspection, and clearer downstream integrations.
...
- How should `Memory Lab` treat card truth so it does not become a second character or lore database? Answered: it may read accepted card truth and author-approved advisory material, but recalled material must preserve authority labels, source trace, and memory type instead of replacing card ownership.
