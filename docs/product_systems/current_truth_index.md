...
- Package `19.22` is closed by exact candidate `c247bb86bf701c577e778356d60bf093a7319855`, its four successful CI runs, the Windows package/install receipt, and Jason's passed core-writing human check. Public release is not authorized; tags, publication, signing, announcements, and alpha/beta claims remain prohibited
