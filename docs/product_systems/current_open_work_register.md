...
| HG-02 | Shell and Companion human gate | [Human Gate 2 Experience Repair Plan](program_4_human_gate_2_experience_repair_plan.md) | repair-active | Human Gate 2 repair sequence | The exact candidate passed automation; Jason did not accept the current Writing Studio experience. Repeat only after the complete continuous-manuscript, unified-rail, real-Focus, and Companion-doorway candidate is qualified |
| HG2-RPR-01 | Continuous Manuscript + Unified Story Rail + Real Focus Mode + Companion Bar | [Human Gate 2 Experience Repair Plan](program_4_human_gate_2_experience_repair_plan.md), [HG2-RPR-A receipt](program_4_hg2_rpr_a_evidence_receipt.md), [HG2-RPR-B receipt](program_4_hg2_rpr_b_evidence_receipt.md), [Program 5 bridge receipt](program_5_hg2_bridge_evidence_receipt.md), [HG2-RPR-C receipt](program_4_hg2_rpr_c_evidence_receipt.md), and [HG2-RPR-D receipt](program_4_hg2_rpr_d_evidence_receipt.md) | repair-active | Bounded HG2 repair plus Program 5 anchor bridge | A is durable at `28d2294a`; B at `707dfae6`; the bridge at `d292e236`; and C at `1da56446`. The first D hosted run found an Electron launch-argument seam; the following hosted run isolated a separate primary-host startup-state race. Full local qualification then exposed one persisted-theme test-isolation race. All three bounded repairs are green in focused CI-mode Electron evidence. Clean hosted Windows package/install qualification of the next exact candidate remains required before human review |
...
| P5-01 | Long-manuscript intake and stable structural anchors | Direction Lock, Program 5, [Human Gate 2 repair plan](program_4_human_gate_2_experience_repair_plan.md), and [bridge receipt](program_5_hg2_bridge_evidence_receipt.md) | implementation-active | Full Program 5 after HG2 repair | Deterministic Markdown intake, project-local structure sidecar, stable anchors, ghost proposals, explicit structural mutations, and transactional apply are implemented in the current candidate; focused development evidence is recorded in the fix tracker. Package qualification, Human Gate 2, substantial-manuscript qualification, and Human Gate 3 remain open |
| P5-UX-01 | Program 5 pre-closure Writing Studio navigation and Unit/Note rail semantics | [Corrected Programs 1–5 repair plan](program_1_to_5_priority_repair_plan.md), [Human Gate 2 repair plan](program_4_human_gate_2_experience_repair_plan.md), [Fix Tracker](../BLACK_SKIES_FIX_TRACKER.md) author findings, and [Program 5 bridge receipt](program_5_hg2_bridge_evidence_receipt.md) | human-review-ready-external-block | Program 5 pre-closure UX repair | Package-qualified candidate `13da251c` is mechanically tested and application-only installed. Its NSIS receipt binds installer SHA `09a41ef179b9d42a32ee42fb2cc0aa3cfe91bae838c2206145d0d30ca056aa69`; packaged startup/export/100-unit/uninstall/reinstall and external-data preservation passed. The current pass also closes staged Structure order on panel close, raises scoped small-text readability, fences packaged native choosers, and completes renderer/post-Apply proof. Exact firewall state is `exact-blocked-external` because this host is not elevated; hands-on product review may begin, but formal Human Gate 2 acceptance still requires the exact firewall witness and Jason's complete review. Do not close Program 5 or advance HG3 on automation alone |
