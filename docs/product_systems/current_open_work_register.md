...
| HG2-RPR-01 | Continuous Manuscript + Unified Story Rail + Real Focus Mode + Companion Bar | [Human Gate 2 Experience Repair Plan](program_4_human_gate_2_experience_repair_plan.md), [HG2-RPR-A receipt](program_4_hg2_rpr_a_evidence_receipt.md), [HG2-RPR-B receipt](program_4_hg2_rpr_b_evidence_receipt.md), [Program 5 bridge receipt](program_5_hg2_bridge_evidence_receipt.md), and [HG2-RPR-C receipt](program_4_hg2_rpr_c_evidence_receipt.md) | repair-active | Bounded HG2 repair plus Program 5 anchor bridge | A is durable at `28d2294a`; B is durable at `707dfae6`; the bridge is durable at `d292e236`; C passed its automated development gate and awaits Jason's commit/push. HG2-RPR-D package/install qualification is next; human review remains deferred until the whole candidate is qualified |
