...
| ARC-P3-03 | Sanitized Command Center Review projection and source return path | Architecture audit `ARC-P3-03` and [P3-F evidence receipt](program_3_batch_p3_f_evidence_receipt.md) | active | Program 3 Batch P3-F | Main-owned role, project, generation, request, unit, selection, stale, action, and exact source-return boundaries are green; Jason's P3-F commit/push supplies durable closure |
| ARC-P3-04 | Dedicated Stage 19 preload parity across development, test, and package hosts | Architecture audit `ARC-P3-04` and [P3-C evidence receipt](program_3_batch_p3_c_evidence_receipt.md) | active | Program 3 Batches P3-C and P3-G | Production and Stage 19 preloads expose the same narrow host contract; exact packaged-host closure remains in P3-G |
| ARC-P3-05 | Truthful active-surface TypeScript boundary | Architecture audit `ARC-P3-05` and [P3-D evidence receipt](program_3_batch_p3_d_evidence_receipt.md) | active | Program 3 Batches P3-D and P3-G | Focused and full typechecks cover the current Writing shell, shared contracts, and Electron evidence; exact through-Program-3 closure remains in P3-G |
| ARC-P3-06 | Scoped Program 3 style and token boundary | Architecture audit `ARC-P3-06`, [P3-D receipt](program_3_batch_p3_d_evidence_receipt.md), [P3-E receipt](program_3_batch_p3_e_evidence_receipt.md), and [P3-F receipt](program_3_batch_p3_f_evidence_receipt.md) | active | Program 3 Batches P3-D through P3-G | The Writing shell, unboxed Living Outline, and black Command task canvas use one restrained scoped token/state layer without global legacy cleanup; final reference and responsive closure remain P3-G |
| ARC-P3-07 | Consistent presentation-state vocabulary over domain-specific errors | Architecture audit `ARC-P3-07` and [P3-F evidence receipt](program_3_batch_p3_f_evidence_receipt.md) | active | Program 3 Batches P3-F and P3-G | Review's advisory, stale, failed, cancelled, expired, dismissed, and unavailable states are green; shell-wide degraded/offline/disabled closure remains P3-G |
...
| TST-P3-02 | Sanitized Review projection evidence | Test audit `TST-P3-02` and [P3-F evidence receipt](program_3_batch_p3_f_evidence_receipt.md) | active | Program 3 Batch P3-F | Command receives only approved advisory projection data; malformed, cross-owner, prose, credential, stale, and action-escalation paths are rejected, and Jason's P3-F commit/push supplies durable closure |
...
| TST-P3-04 | Presentation-state and changed-shell accessibility matrix | Test audit `TST-P3-04`, [P3-D receipt](program_3_batch_p3_d_evidence_receipt.md), [P3-E receipt](program_3_batch_p3_e_evidence_receipt.md), and [P3-F receipt](program_3_batch_p3_f_evidence_receipt.md) | active | Program 3 Batches P3-D through P3-G | Writing, Living Outline, and Review semantics, keyboard/focus behavior, Focus mode, terminal/stale states, degraded sidecar behavior, and axe evidence are green; final changed-shell closure remains in P3-G |
| TST-P3-05 | Layered visual and responsive evidence | Test audit `TST-P3-05`, [P3-D evidence receipt](program_3_batch_p3_d_evidence_receipt.md), and [P3-F evidence receipt](program_3_batch_p3_f_evidence_receipt.md) | active | Program 3 and Human Gate 2 | Approved Writing and Command tokens, component semantics, and built-Electron viewport evidence are green; P3-G reference/responsive evidence and Human Gate 2 retain visual acceptance |
| TST-P3-06 | Development, test, build, and package authority parity | Test audit `TST-P3-06`, [P3-C receipt](program_3_batch_p3_c_evidence_receipt.md), [P3-D receipt](program_3_batch_p3_d_evidence_receipt.md), [P3-E receipt](program_3_batch_p3_e_evidence_receipt.md), and [P3-F receipt](program_3_batch_p3_f_evidence_receipt.md) | active | Program 3 Batches P3-C through P3-G | Host/preload/type/lint/build/Electron parity, Living Outline and Review workflows, performance, and package-safe configuration are green; exact packaged-host and installed closure remain in P3-G and the combined candidate |
...
| SKP-04 | Strict visual snapshot lane opt-in skip | Intentional-skip inventory, fix tracker issue 43, test audit `TST-P3-05`, [P3-D receipt](program_3_batch_p3_d_evidence_receipt.md), [P3-E receipt](program_3_batch_p3_e_evidence_receipt.md), and [P3-F receipt](program_3_batch_p3_f_evidence_receipt.md) | active | Program 3 and Human Gate 2 | Semantic token/component checks and deterministic built-Electron evidence cover Writing, Living Outline, and Command Review; P3-G references and Human Gate 2 complete the approved layered strategy |
...
| P3-01 | Contextual product shell | [Program 3 implementation plan](program_3_contextual_product_shell_implementation_plan.md), [P3-A receipt](program_3_batch_p3_a_evidence_receipt.md), [P3-B receipt](program_3_batch_p3_b_evidence_receipt.md), [P3-C receipt](program_3_batch_p3_c_evidence_receipt.md), [P3-D receipt](program_3_batch_p3_d_evidence_receipt.md), [P3-E receipt](program_3_batch_p3_e_evidence_receipt.md), and [P3-F receipt](program_3_batch_p3_f_evidence_receipt.md) | active | Program 3 | P3-A through P3-E are durable at `4007e12a`, `2ff0361c`, `3de76ee1`, `fb232066`, and `fec27147`; P3-F implementation and automation are green; Jason's exact P3-F commit/push makes P3-G the next executable batch |
