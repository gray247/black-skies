...
| P4-01 | Minimal Companion and owner routing | [Program 4 implementation plan](program_4_minimal_companion_owner_routing_implementation_plan.md), [P4-A evidence receipt](program_4_batch_p4_a_evidence_receipt.md), and [P4-B evidence receipt](program_4_batch_p4_b_evidence_receipt.md) | active | Program 4 P4-B Git checkpoint | Jason approved Program 4 and the required `GPT-5.6 Terra` high-reasoning model change; P4-A is durable at `fc759a6847d82531eb4a8939d20a71d90ab423d7`; P4-B implementation and automation are green, awaiting exact commit/push before P4-C |
