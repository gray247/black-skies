...
| ARC-P3-06 | Scoped Program 3 style and token boundary | Architecture audit `ARC-P3-06`, [P3-D receipt](program_3_batch_p3_d_evidence_receipt.md), and [P3-E receipt](program_3_batch_p3_e_evidence_receipt.md) | active | Program 3 Batches P3-D through P3-G | The Writing shell and unboxed Living Outline use one restrained scoped token/state layer without global legacy cleanup; later surfaces retain their own bounded presentation work |
...
| TST-P3-04 | Presentation-state and changed-shell accessibility matrix | Test audit `TST-P3-04`, [P3-D receipt](program_3_batch_p3_d_evidence_receipt.md), and [P3-E receipt](program_3_batch_p3_e_evidence_receipt.md) | active | Program 3 Batches P3-D through P3-G | Writing and Living Outline semantics, keyboard movement, focus behavior, Focus mode, responsive support, degraded sidecar behavior, and axe evidence are green; final changed-shell closure remains in P3-G |
| TST-P3-05 | Layered visual and responsive evidence | Test audit `TST-P3-05` and [P3-D evidence receipt](program_3_batch_p3_d_evidence_receipt.md) | active | Program 3 and Human Gate 2 | Approved Writing tokens, component semantics, and built-Electron viewport evidence are green; later surface evidence and Human Gate 2 retain visual acceptance |
| TST-P3-06 | Development, test, build, and package authority parity | Test audit `TST-P3-06`, [P3-C receipt](program_3_batch_p3_c_evidence_receipt.md), [P3-D receipt](program_3_batch_p3_d_evidence_receipt.md), and [P3-E receipt](program_3_batch_p3_e_evidence_receipt.md) | active | Program 3 Batches P3-C through P3-G | Host/preload/type/lint/build/Electron parity, the revised Living Outline workflow, and package-safe configuration are green; exact packaged-host and installed closure remain in P3-G and the combined candidate |
...
| SKP-04 | Strict visual snapshot lane opt-in skip | Intentional-skip inventory, fix tracker issue 43, test audit `TST-P3-05`, [P3-D receipt](program_3_batch_p3_d_evidence_receipt.md), and [P3-E receipt](program_3_batch_p3_e_evidence_receipt.md) | active | Program 3 and Human Gate 2 | Semantic token/component checks and deterministic built-Electron evidence cover the Writing shell and Living Outline interaction; later surfaces and Human Gate 2 complete the approved layered strategy |
