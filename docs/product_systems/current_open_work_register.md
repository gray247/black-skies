...
| P6-01 | Signal posture and story intelligence | [Program 6 implementation plan](program_6_signals_story_intelligence_implementation_plan.md), [P6-A Luna high handoff prompt](program_6_batch_p6_a_luna_high_handoff_prompt.md), and [P6-A evidence receipt](program_6_batch_p6_a_evidence_receipt.md) | closed-mechanical | Program 6 P6-A | P6-A contract, policy, project-local persistence, typed Writing Studio IPC, preload parity, focused tests, typecheck, compile, lint, and docs gates are green; P6-B and product-facing intelligence remain separately gated |
