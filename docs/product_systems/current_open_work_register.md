...
| P4-01 | Minimal Companion and owner routing | [Program 4 implementation plan](program_4_minimal_companion_owner_routing_implementation_plan.md) and [P4-A through P4-C evidence receipts](program_4_batch_p4_c_evidence_receipt.md) | active | Program 4 exact-candidate checkpoint | Jason approved Program 4 and the required `GPT-5.6 Terra` high-reasoning model change; P4-A is durable at `fc759a6847d82531eb4a8939d20a71d90ab423d7`; P4-B is durable at `f6090498a8ea04f011fc30c890af521aa712940e`; the first P4-C exact checkpoint exposed a Windows visual-capture seam, and its bounded frame repair plus full dirty-development regression are green locally, awaiting exact commit/push before repeated package/install qualification |
