...
| P6-01 | Signal posture and story intelligence | [Program 6 implementation plan](program_6_signals_story_intelligence_implementation_plan.md), [P6-F Luna high handoff prompt](program_6_batch_p6_f_luna_high_handoff_prompt.md), and [P6-F evidence receipt](program_6_batch_p6_f_evidence_receipt.md) | active | Program 6 P6-F | P6-E is durable at `bb7f45db`; P6-F mechanical qualification over three synthetic projects and the existing Electron/accessibility/performance boundary is active pending F gates |
