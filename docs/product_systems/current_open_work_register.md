...
| ARC-P3-02 | Behavior-locked Stage 19 controller/view decomposition | Architecture audit `ARC-P3-02` and [P3-B evidence receipt](program_3_batch_p3_b_evidence_receipt.md) | active | Program 3 Batch P3-B | Explicit stateless views consume controller-owned state/actions while existing workflow state machines remain singular; durable closure waits for the exact P3-B commit and push |
...
| P3-01 | Contextual product shell | [Program 3 implementation plan](program_3_contextual_product_shell_implementation_plan.md), [P3-A receipt](program_3_batch_p3_a_evidence_receipt.md), and [P3-B receipt](program_3_batch_p3_b_evidence_receipt.md) | active | Program 3 | P3-A is durable at `4007e12a`; P3-B implementation and automation are green; Jason's exact P3-B commit/push makes P3-C the next executable batch |
