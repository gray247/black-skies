...
| ARC-P3-01 | Logical surface host independent of mandatory physical-window placement | Architecture audit `ARC-P3-01` and [P3-C evidence receipt](program_3_batch_p3_c_evidence_receipt.md) | active | Program 3 Batch P3-C | Single-screen and optional-secondary logical hosts preserve one Writing owner; durable closure waits for the exact P3-C commit and push |
...
| TST-P3-01 | Logical surface-host authority evidence | Test audit `TST-P3-01` and [P3-C evidence receipt](program_3_batch_p3_c_evidence_receipt.md) | active | Program 3 Batch P3-C | Deterministic unit and built-Electron evidence proves one project and one Writing mutation owner; durable closure waits for the exact P3-C commit and push |
...
| TST-P3-06 | Development, test, build, and package authority parity | Test audit `TST-P3-06` and [P3-C evidence receipt](program_3_batch_p3_c_evidence_receipt.md) | active | Program 3 Batches P3-C and P3-G | Host/preload/type/build parity and package-safe configuration are green; exact packaged-host and installed closure remain in P3-G and the combined candidate |
...
| P3-01 | Contextual product shell | [Program 3 implementation plan](program_3_contextual_product_shell_implementation_plan.md), [P3-A receipt](program_3_batch_p3_a_evidence_receipt.md), [P3-B receipt](program_3_batch_p3_b_evidence_receipt.md), and [P3-C receipt](program_3_batch_p3_c_evidence_receipt.md) | active | Program 3 | P3-A and P3-B are durable at `4007e12a` and `2ff0361c`; P3-C implementation and automation are green; Jason's exact P3-C commit/push makes P3-D the next executable batch |
