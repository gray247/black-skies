...
| P3-01 | Contextual product shell | [Program 3 implementation plan](program_3_contextual_product_shell_implementation_plan.md) and [Program 3 closure receipt](program_3_closure_receipt.md) | active | Program 3 P3-G Git checkpoint | P3-A through P3-F are durable; P3-G implementation and automation are green; Jason's exact P3-G commit/push makes Program 3 durably complete |
| P4-01 | Minimal Companion and owner routing | Post-V1 Master Program, Program 4 | next | Program 4 | Jason pushes the exact P3-G closure batch and confirms the required model change |
