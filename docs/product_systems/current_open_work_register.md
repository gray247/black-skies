...
| HG2-RPR-01 | Continuous Manuscript + Unified Story Rail + Real Focus Mode + Companion Bar | [Human Gate 2 Experience Repair Plan](program_4_human_gate_2_experience_repair_plan.md), [HG2-RPR-A receipt](program_4_hg2_rpr_a_evidence_receipt.md), and [HG2-RPR-B receipt](program_4_hg2_rpr_b_evidence_receipt.md) | repair-active | Bounded HG2 repair plus Program 5 anchor bridge | HG2-RPR-A is durable at `28d2294a`; HG2-RPR-B passed its complete automated development gate and waits for Jason's manual commit/push, after which the Program 5 continuous-manuscript and stable-anchor bridge is next |
...
| P5-01 | Long-manuscript intake and stable structural anchors | Direction Lock, Program 5, and Human Gate 2 repair plan | next | Program 5 anchor bridge | Pulled forward as the prerequisite for a true continuous manuscript; Human Gate 3 remains its long-manuscript integrity gate |
