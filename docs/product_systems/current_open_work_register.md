...
| P5-UX-01 | Program 5 pre-closure Writing Studio navigation and Unit/Note rail semantics | [Corrected Programs 1–5 repair plan](program_1_to_5_priority_repair_plan.md), [Human Gate 2 repair plan](program_4_human_gate_2_experience_repair_plan.md), [Fix Tracker](../BLACK_SKIES_FIX_TRACKER.md) author findings, and historical [Program 5 bridge receipt](program_5_hg2_bridge_evidence_receipt.md) | repair-active | Program 5 pre-closure UX repair | Package-qualified candidate `e3b6ea95` is mechanically tested and application-only installed. Its NSIS receipt binds installer SHA `88bed96614a1ff674593749c71505f5ea943c3a55ca4ec1d94b28de0ad08c866`; packaged startup/export/100-unit/uninstall/reinstall and external-data preservation passed. Exact firewall state is `exact-blocked-external` because this host is not elevated; the exact firewall witness and one complete Human Gate 2 review remain. Do not close Program 5 or advance HG3 on automation alone |
