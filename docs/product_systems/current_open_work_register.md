...
| P6-01 | Signal posture and story intelligence | [Program 6 implementation plan](program_6_signals_story_intelligence_implementation_plan.md), [P6-E Luna high handoff prompt](program_6_batch_p6_e_luna_high_handoff_prompt.md), and [P6-E evidence receipt](program_6_batch_p6_e_evidence_receipt.md) | active | Program 6 P6-E | P6-D is durable at `32d0c617`; the bounded quiet Writing Surface cue, Story Knowledge detail path, Focus hiding rule, and local-only gateway are active pending P6-E gates |
