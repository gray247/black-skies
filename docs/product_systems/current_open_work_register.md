...
| P4-01 | Minimal Companion and owner routing | [Program 4 implementation plan](program_4_minimal_companion_owner_routing_implementation_plan.md) and [P4-A evidence receipt](program_4_batch_p4_a_evidence_receipt.md) | active | Program 4 P4-A Git checkpoint | Jason approved Program 4 and the required `GPT-5.6 Terra` high-reasoning model change; P4-A contract and automation are green, awaiting exact commit/push before P4-B |
