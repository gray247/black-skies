...
| P6-01 | Signal posture and story intelligence | [Program 6 implementation plan](program_6_signals_story_intelligence_implementation_plan.md), [P6-B Luna high handoff prompt](program_6_batch_p6_b_luna_high_handoff_prompt.md), and [P6-B evidence receipt](program_6_batch_p6_b_evidence_receipt.md) | closed-mechanical | Program 6 P6-B | P6-A and P6-B bounded contracts, persistence, deterministic projection, reusable component, focused tests, typecheck, compile, build, lint, docs, dirty regression, startup preflight, and Electron matrix are green; P6-C and product-facing intelligence remain separately gated |
