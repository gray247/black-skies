...
| P4-01 | Minimal Companion and owner routing | [Program 4 implementation plan](program_4_minimal_companion_owner_routing_implementation_plan.md), Post-V1 Master Program, Program 4 | in-planning | Program 4 | P3-G is pushed and the required `GPT-5.6 Terra` high-reasoning model change is confirmed; await Jason's exact Program 4 runtime authorization before P4-A |
