...
| HG2-RPR-01 | Continuous Manuscript + Unified Story Rail + Real Focus Mode + Companion Bar | [Human Gate 2 Experience Repair Plan](program_4_human_gate_2_experience_repair_plan.md), [HG2-RPR-A receipt](program_4_hg2_rpr_a_evidence_receipt.md), [HG2-RPR-B receipt](program_4_hg2_rpr_b_evidence_receipt.md), and [Program 5 bridge receipt](program_5_hg2_bridge_evidence_receipt.md) | repair-active | Bounded HG2 repair plus Program 5 anchor bridge | HG2-RPR-A is durable at `28d2294a`; HG2-RPR-B is durable at `707dfae6`; the continuous-manuscript/stable-anchor bridge passed its complete automated development gate and waits for Jason's manual commit/push; HG2-RPR-C is next |
