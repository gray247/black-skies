...
| P4-01 | Minimal Companion and owner routing | [Program 4 implementation plan](program_4_minimal_companion_owner_routing_implementation_plan.md) and [P4-A through P4-C evidence receipts](program_4_batch_p4_c_evidence_receipt.md) | active | Program 4 exact-candidate checkpoint | Jason approved Program 4 and the required `GPT-5.6 Terra` high-reasoning model change; P4-A is durable at `fc759a6847d82531eb4a8939d20a71d90ab423d7`; P4-B is durable at `f6090498a8ea04f011fc30c890af521aa712940e`; the comprehensive P4-C repair separates the historical V1 two-window record from the current Writing-first, optional-secondary topology; its first clean hosted run exposed a post-teardown measurement-handle defect and its second exposed a missing post-request visibility field, both now repaired and directly covered locally; the full clean candidate package/install qualification awaits Jason's exact commit and push |
