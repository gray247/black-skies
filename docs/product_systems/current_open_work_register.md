...
| ARC-P3-06 | Scoped Program 3 style and token boundary | Architecture audit `ARC-P3-06` and [P3-D evidence receipt](program_3_batch_p3_d_evidence_receipt.md) | active | Program 3 Batches P3-D through P3-G | The Writing shell uses one restrained scoped token/state layer without global legacy cleanup; durable P3-D closure waits for the author checkpoint and later surfaces retain their own bounded presentation work |
...
| TST-P3-04 | Presentation-state and changed-shell accessibility matrix | Test audit `TST-P3-04` and [P3-D evidence receipt](program_3_batch_p3_d_evidence_receipt.md) | active | Program 3 Batches P3-D and P3-G | Writing semantics, keyboard disclosure, focus return, Focus mode, responsive support, reduced motion, recovery/failure states, and axe evidence are green; final changed-shell closure remains in P3-G |
...
| TST-P3-06 | Development, test, build, and package authority parity | Test audit `TST-P3-06`, [P3-C receipt](program_3_batch_p3_c_evidence_receipt.md), and [P3-D receipt](program_3_batch_p3_d_evidence_receipt.md) | active | Program 3 Batches P3-C through P3-G | Host/preload/type/lint/build/Electron parity and package-safe configuration are green; exact packaged-host and installed closure remain in P3-G and the combined candidate |
...
| SKP-04 | Strict visual snapshot lane opt-in skip | Intentional-skip inventory, fix tracker issue 43, test audit `TST-P3-05`, and [P3-D evidence receipt](program_3_batch_p3_d_evidence_receipt.md) | active | Program 3 and Human Gate 2 | Semantic token/component checks and deterministic built-Electron viewport evidence now cover the Writing shell; later surfaces and Human Gate 2 complete the approved layered strategy |
...
| P3-01 | Contextual product shell | [Program 3 implementation plan](program_3_contextual_product_shell_implementation_plan.md), [P3-A receipt](program_3_batch_p3_a_evidence_receipt.md), [P3-B receipt](program_3_batch_p3_b_evidence_receipt.md), [P3-C receipt](program_3_batch_p3_c_evidence_receipt.md), and [P3-D receipt](program_3_batch_p3_d_evidence_receipt.md) | active | Program 3 | P3-A through P3-C are durable at `4007e12a`, `2ff0361c`, and `3de76ee1`; P3-D implementation and automation are green; Jason's exact P3-D commit/push makes P3-E the next executable batch |
