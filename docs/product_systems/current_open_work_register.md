...
| HG2-RPR-01 | Continuous Manuscript + Unified Story Rail + Real Focus Mode + Companion Bar | [Human Gate 2 Experience Repair Plan](program_4_human_gate_2_experience_repair_plan.md) and [HG2-RPR-A receipt](program_4_hg2_rpr_a_evidence_receipt.md) | repair-active | Bounded HG2 repair plus Program 5 anchor bridge | HG2-RPR-A passed its complete automated development gate; Jason's manual commit/push makes it durable, after which HG2-RPR-B is the next bounded batch |
