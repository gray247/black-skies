...
| P6-01 | Signal posture and story intelligence | [Program 6 implementation plan](program_6_signals_story_intelligence_implementation_plan.md), [P6-D Luna high handoff prompt](program_6_batch_p6_d_luna_high_handoff_prompt.md), and [P6-D evidence receipt](program_6_batch_p6_d_evidence_receipt.md) | active | Program 6 P6-D | P6-C is mechanically complete at `7536431d`; Timeline V1 chronology, pacing, and pressure gates are green, with the exact P6-D commit/clean/push handoff remaining to be recorded |
