...
| ARC-P3-04 | Dedicated Stage 19 preload parity across development, test, and package hosts | Architecture audit `ARC-P3-04` and [Program 3 closure receipt](program_3_closure_receipt.md) | closed | Program 3 P3-C through P3-G | Production and Stage 19 preloads expose the same narrow host contract through type, build, Electron, and package preflight; exact combined installed parity remains Human Gate 2 candidate work |
...
| TST-P3-05 | Layered visual and responsive evidence | Test audit `TST-P3-05` and [Program 3 closure receipt](program_3_closure_receipt.md) | owned-later | Human Gate 2 | Program 3 semantic, responsive, and targeted Windows references are green; only subjective combined shell-and-Companion acceptance remains |
| TST-P3-06 | Development, test, build, and package authority parity | Test audit `TST-P3-06` and [Program 3 closure receipt](program_3_closure_receipt.md) | owned-later | Combined Program 3 plus Program 4 candidate | Program 3 type, lint, build, Electron, regression, and package preflight are green; exact package/install and offline lifecycle wait for the whole Human Gate 2 candidate |
...
| UX-01 | Project creation and startup experience is mechanically sound but visually weak | Fix-tracker normalized issue 26, Human Gate 1 synthesis, and Program 3 shell | owned-later | Human Gate 2 | Program 3 supplies the new startup and project-entry treatment; the combined shell-and-Companion review decides whether the writer experience is accepted |
...
| SKP-04 | Historical portable whole-page visual snapshot remains opt-in | Intentional-skip inventory, test audit `TST-P3-05`, and [Program 3 closure receipt](program_3_closure_receipt.md) | owned-later | Human Gate 2 / later visual-strategy replacement | Targeted Windows Writing and Command references plus semantic/responsive evidence are green; portable whole-page pixel equality is not required and subjective acceptance remains Human Gate 2 |
...
| HG-02 | Shell and Companion human gate | [Human Gate 2 Experience Repair Plan](program_4_human_gate_2_experience_repair_plan.md) | human-review-ready | Final Human Gate 2 author decision | The repaired Writing Studio and exact opening-page candidate are mechanically green, package-qualified, installed, and visually rehearsed. Jason accepted the preceding repaired surfaces; one final review of exact product commit `0735b11d` remains before the gate is recorded closed |
| HG2-RPR-01 | Continuous Manuscript + Unified Story Rail + Real Focus Mode + Companion Bar | [Human Gate 2 Experience Repair Plan](program_4_human_gate_2_experience_repair_plan.md), [HG2-RPR-A receipt](program_4_hg2_rpr_a_evidence_receipt.md), [HG2-RPR-B receipt](program_4_hg2_rpr_b_evidence_receipt.md), [Program 5 bridge receipt](program_5_hg2_bridge_evidence_receipt.md), [HG2-RPR-C receipt](program_4_hg2_rpr_c_evidence_receipt.md), and [HG2-RPR-D receipt](program_4_hg2_rpr_d_evidence_receipt.md) | human-review-ready | Final HG2 author decision | A is durable at `28d2294a`; B at `707dfae6`; the bridge at `d292e236`; and C at `1da56446`. Subsequent launcher, shell, rail, Note, contrast, geometry, startup, and long-title repairs culminate in exact product commit `0735b11d`, which passed clean regression, exact package verification, installed lifecycle, and Windows visual rehearsal. Only final author acceptance remains |
| CLN-A | First legacy disposition, archive/delete, and professionalization wave | Reachability inventory and current code audit | owned-later | After repaired Human Gate 2 | Redesigned shell is accepted and replacement relationships are provable |
| P5-01 | Long-manuscript intake and stable structural anchors | Direction Lock, Program 5, [Human Gate 2 repair plan](program_4_human_gate_2_experience_repair_plan.md), and [bridge receipt](program_5_hg2_bridge_evidence_receipt.md) | human-review-ready | Human Gate 3 | Deterministic Markdown intake, project-local versioned sidecar, 120 unique stable anchors over a generated 300,000-plus-character manuscript, paginated ghost proposals, rename/accept/reject, transactional Apply, exact source-byte preservation, and durable reopen state are mechanically qualified on exact product commit `0735b11d`. A user-supplied substantial manuscript is not required; only human structural-workflow judgment remains |
| P5-UX-01 | Program 5 pre-closure Writing Studio navigation and Unit/Note rail semantics | [Corrected Programs 1–5 repair plan](program_1_to_5_priority_repair_plan.md), [Human Gate 2 repair plan](program_4_human_gate_2_experience_repair_plan.md), [Fix Tracker](../BLACK_SKIES_FIX_TRACKER.md) author findings, and [Program 5 bridge receipt](program_5_hg2_bridge_evidence_receipt.md) | human-review-ready | Final Human Gate 2 author decision | Exact product commit `0735b11d` passed `49` critical files / `748` passed / `2` skipped, startup preflight `1/1`, Electron `34/34`, exact package verification, application-only install/uninstall/reinstall, and installed Windows visual rehearsal. The app creates no firewall rule; supplemental outbound isolation is not a product-closure prerequisite. Final human acceptance and Program 5 closure remain unclaimed |
| HG-03 | Long-manuscript integrity and usability | Execution-control plan | human-review-ready | Human Gate 3 | Mechanical qualification uses a deterministic 120-chapter, 300,000-plus-character Markdown manuscript and proves bounded rendering, unique anchors, mutations, Apply, source preservation, and reopen durability. Human judgment of the structural workflow remains |
