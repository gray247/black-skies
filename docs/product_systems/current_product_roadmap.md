...
- Package `19.22` is closed by exact candidate `c247bb86bf701c577e778356d60bf093a7319855`, four successful exact CI runs, the Windows package/install proof, and Jason's passed core-writing check. It created no tag, public release, signing request, publication, announcement, or alpha/beta claim; public consideration remains deferred to separately authorized future work
