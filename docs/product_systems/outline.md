...
The writer needs a way to sketch structure, organize progression, compare alternative sequences, and navigate evolving work without turning planning into a mandatory gate before writing can begin.

## 4. What The System Does

The Outline system:

- supports idea-first planning,
- supports gap-first planning,
...
- may hold structural pacing intent or node-level pacing targets as
  planning state,
...
Background behavior must remain support behavior rather than hidden authority.
...
Summonable within or around Outline:

- node detail,
- reorder tools,
- linked insertion or assertion context,
...
- deep restructure alternatives,
- imported planning cleanup suggestions,
...
These outputs support structure; they do not replace narrative truth.
...
Downstream consumers must treat outline state as planning context, not as automatic authored narrative fact.
...
Outline may reference Story Units when useful, but Story Units remain optional and Outline remains optional.

Neither system should become the mandatory gate for the other.

## 18. Relationship To Prose / Scene Projection

Outline may reference prose or projection containers where that helps planning or compatibility, but projection layers remain downstream views or containers.
...
Direct writing works without Outline.
...
Outline will likely live primarily in the Command Center because it is a planning and navigation system.
...
Routing must stay behind later policy layers.

Outline-related model flows must preserve:
...
If outline content is routed through model systems later, privacy and safety rules must ensure:
