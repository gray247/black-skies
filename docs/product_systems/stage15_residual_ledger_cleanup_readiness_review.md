...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| retained sample-root repair/regeneration ownership and current-vs-historical classification | out-of-scope deferred | Stage 15 / residual-ledger and Stage 16 readiness review | `later explicitly authorized current-versus-historical classification lane or separate Stage 16 readiness handoff, if needed` | not yet authorized | later explicit authorization of current-versus-historical classification beyond this read-only review | non-blocking for Stage 15 because this review only classifies and preserves ownership visibility; no accepted evidence requires repair or movement now | Yes | if the initially expected home is treated as closed or skipped, retain it in the current Stage 15 review and assign it to a later explicitly authorized current-versus-historical lane |
