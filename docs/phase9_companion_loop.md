# docs/phase9_companion_loop.md — DRAFT
...
## Endpoints (extends `docs/endpoints.md`)
...
## Telemetry (see `docs/performance_telemetry_policy.md`)
...
## GUI Wiring (see `docs/gui_layouts.md`)
