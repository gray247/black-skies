...
## Canonical Usage
Use these terms consistently across UI strings, telemetry counters, and docs to avoid ambiguity between manual review, Insights Overlay, and automated critique pipelines.
