...
| --- | --- | --- | --- |
| 1 | API docs refreshed | Complete | [`docs/specs/endpoints.md`](endpoints.md) documents `/api/v1/healthz`, `/api/v1/metrics`, and the `trace_id` + `x-trace-id` error contract. |
| 2 | Architecture docs updated | Complete | [`docs/specs/architecture.md`](architecture.md) calls out `/api/v1/healthz`, Prometheus metrics, and trace headers in the service overview. |
...
| 5 | Roadmap & logs flipped to ✅ | Complete | [`docs/roadmap.md`](roadmap.md) and [`docs/phases/phase_log.md`](phase_log.md) mark P4.1 complete with release notes. |
