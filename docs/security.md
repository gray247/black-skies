# docs/security.md — Security Posture Summary
...
- [`docs/security_sweep.md`](./security_sweep.md) — Phase 8 dependency and configuration audit log.
...
- Capture any manual review notes from security sweeps in `docs/security_sweep.md` so future audits see the full context.
