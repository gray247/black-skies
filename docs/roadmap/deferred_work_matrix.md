...
| RDM-WRAPPER-001 | `TRACKER-2026-05-14-WRAPPER`, `RISK-WRAPPER-001` | Wrapper / launcher / CWD authority and execution determinism | S1 Closure-critical | Operator workflow | Active blocker | Open | `A1`, `A2`, `A3`, `A5`, `A6` | Broad implementation work can exercise different roots, env assumptions, or launcher semantics and still appear healthy | Later | Phase 16 | wrapper/launcher/CWD audit and canonical command recipe | `RDM-TRUTH-001`, `RDM-HARNESS-001`, `RDM-CI-001`, `RDM-RISK-001` | Tracker wrapper audit follow-up, [wrapper_launcher_cwd_audit.md](/C:/Dev/black-skies/docs/audits/phase14/wrapper_launcher_cwd_audit.md) | Cross-surface item affecting operator workflow, CI/GitHub Actions, and Playwright/harness readiness for broad `/goals` and deeper `14B` work |
