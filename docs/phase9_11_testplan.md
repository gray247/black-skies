# docs/phase9_11_testplan.md — DRAFT
...
- **Telemetry Assertions:** Ensure `critique.accept_rate` stays between 0–100, durations are captured, and no PII is emitted. Validate telemetry counters from `docs/performance_telemetry_policy.md` appear in the JSONL stream.
