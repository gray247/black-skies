...
- **Voice Input Handler:** The dictation/voice-note workflow described in [Voice Notes plan](./voice_notes_transcription.md) remains scoped but not shipped; no recorder/transcription endpoints or UI exist in production.
