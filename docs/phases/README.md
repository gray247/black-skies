...
- `phase_charter.md`
- `phase_log.md`
- `phase8_gui_enhancements.md`
- `phase9_charter.md`
- `phase9_11_testplan.md`
- `phase9_companion_loop.md`
- `phase10_recovery_pipeline.md`
- `phase11_export_pipeline.md`
- `dashboard_initiatives.md`

Use this folder for active phase definitions; migrated or deferred explorations belong in `docs/deferred/`.
