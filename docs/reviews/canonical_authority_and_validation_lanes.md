...
| Testing / validation guidance | `docs/reviews/canonical_authority_and_validation_lanes.md` for this planning pass; `docs/tests.md` is legacy / supporting reference | `docs/ops/repo_hygiene.md`, `docs/phases/phase_charter.md`, `docs/roadmap.md` | `docs/tests.md` when read as an older gate map, smoke-only launchers, UI-only harness docs, review artifacts | `docs/tests.md` still reads like a broader gate map and can overstate what a command proves. |
